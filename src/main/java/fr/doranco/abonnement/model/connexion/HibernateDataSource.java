package fr.doranco.abonnement.model.connexion;
...
//													  // puis va charger tous les param�tres qui y sont indiqu�s.
...
//			sessionFactory = config.buildSessionFactory(serviceRegistry);
			...
			System.out.println("Echec de la Creation et de l'initialisation de la SessionFactory !");
